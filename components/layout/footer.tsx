...
export function Footer() {
  ...
  return (
    <footer className="fixed inset-x-0 bottom-0 z-100 border-t border-black/10 bg-white/95 pb-[env(safe-area-inset-bottom)] backdrop-blur md:static md:bg-white md:pb-0">
